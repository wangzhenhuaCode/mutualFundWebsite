...
<div class="Menu">
            <ul><li><a href="<%=basePath%>act/employee_" class="MenuButton"><span>Home</span></a></li><li><a href="<%=basePath%>act/employee_viewCustomers.action" class="MenuButton"><span>Account Management</span></a></li> <li><a href="employee_fund.html" class="ActiveMenuButton"><span>Fund Management</span></a></li></ul>
        </div>
