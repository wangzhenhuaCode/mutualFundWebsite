...
<jsp:include page="template-top.jsp" />
    ...
    <div class="Menu">
            <ul><li><a href="#" class="MenuButton"><span>Home</span></a></li> <li><a href="<%=basePath%>act/trade_gotoTrade.action" class="ActiveMenuButton"><span>Trade</span></a></li> <li><a class="MenuButton" href="Finance.html" ><span>Finance</span></a></li> <li><a href="History.html" class="MenuButton"><span>History</span></a></li></ul>
        </div>
